...
<table>
  <tr>
    ...
    <td valign="top">
      <p>Maintained and published by <strong>Anatoliy Yermakov</strong> for the <strong>SYT open-source community</strong>.</p>
      <p>This package is publicly available for any team or developer who needs a robust .NET Fiskaly integration.</p>
    </td>
  </tr>
</table>
